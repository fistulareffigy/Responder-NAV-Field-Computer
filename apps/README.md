...
- `deploy_cam` — quick-deploy ESP32 camera viewer and recorder
- `drone_detection` — dedicated RTL-SDR drone signal monitor
- `ghost_box` — RTL-SDR scanning and triggered-audio experiment
- `rf_watch` — Wi-Fi RF/network watch tools

Wi-Fi Motion is intentionally excluded because it is not reliable enough for
this beta.
