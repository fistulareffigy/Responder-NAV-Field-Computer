...
static esp_err_t s_sccb_i2c_transmit_reg_a8v8(esp_sccb_io_t *io_handle, const uint8_t *write_buffer,
                                              size_t write_size, int xfer_timeout_ms);
static esp_err_t s_sccb_i2c_transmit_reg_a16v8(esp_sccb_io_t *io_handle, const uint8_t *write_buffer,
                                               size_t write_size, int xfer_timeout_ms);
static esp_err_t s_sccb_i2c_transmit_reg_a8v16(esp_sccb_io_t *io_handle, const uint8_t *write_buffer,
                                               size_t write_size, int xfer_timeout_ms);
