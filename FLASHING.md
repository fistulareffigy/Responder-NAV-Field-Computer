...
```powershell
esptool --chip esp32p4 --port COM_PORT --baud 460800 write-flash 0x0 Responder-Nav-v0.71-Beta-factory.bin
```
...
```powershell
esptool --chip esp32p4 --port COM_PORT --baud 460800 write-flash 0x10000 Responder-Nav-v0.71-Beta-app.bin
```
...
```powershell
esptool --chip esp32 --port CAMERA_PORT --baud 115200 write-flash 0x0 Deploy-Cam-v0.71-Beta-Freenove-factory.bin
```

For a camera that already has the matching bootloader and partition table:

```powershell
esptool --chip esp32 --port CAMERA_PORT --baud 115200 write-flash 0x10000 Deploy-Cam-v0.71-Beta-Freenove-app.bin
```
